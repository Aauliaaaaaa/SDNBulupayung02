...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a class="brand-link">
      ...
      <span class="brand-text font-weight-light">SD N Bulupayung 02</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
            <a href="{{ route('profile.edit') }}" class="d-block">Hallo {{ Auth::user()->name }}!</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/admin/jumlahs" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Data Jumlah</p>
                </a>
              </li>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy;{{date('Y')}} <a href="https://adminlte.io">Aulia Nabilah</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
