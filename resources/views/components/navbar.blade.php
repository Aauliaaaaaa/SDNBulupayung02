    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto" >
          <li class="nav-item">
            <a class="nav-link fw-bolder {{ Request::is('/') ? 'primary' : "" }}" href="/">Home</a>
          </li>
          <li class="nav-item fw-bolder dropdown">
            <a class="nav-link {{ Request::is('/profile') ? 'primary' : "" }}" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
             Profile
            </a>
